...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_56-72_EF1e-12
#SBATCH -o 1hel-sensor_56-72_EF1e-12-%j.out
#SBATCH -e 1hel-sensor_56-72_EF1e-12-%j.err
#SBATCH --mem=2G
...
echo "Tilt begin: 56° - Tilt_end: 72° - Ntilt: 1 -- Rot begin: 0° - Rot end: 360° - Nrot: 36"
echo "...................................................................................."
echo "Proteina-Superficie: Lisozima - Surf Cargada -0.04 C/m^2."
echo "Separación: 0.2 nm"
python generador_config_file.py 1hel_sensor 1hel mesh/1hel_d16_split 56 72 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel 1hel_sensor/mesh/1hel_d16_split 56 72 9 2 1hel-sensor_56-72-2_EF1e-12
