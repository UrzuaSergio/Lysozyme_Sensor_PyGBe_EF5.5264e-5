...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel_44-60_EF-5.5264e-4
#SBATCH -o 1hel_44-60_EF-5.5264e-4-%j.out
#SBATCH -e 1hel_44-60_EF-5.5264e-4-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_isolated 1hel mesh/1hel_d16_split 44 60 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_isolated 1hel_isolated/1hel 1hel_isolated/mesh/1hel_d16_split 44 60 5 2 1hel-isolated_44-60-2_EF-5.5264e-4
