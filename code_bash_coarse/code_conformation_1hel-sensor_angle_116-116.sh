...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_116-116_EF1e-12
#SBATCH -o 1hel-sensor_116-116_EF1e-12-%j.out
#SBATCH -e 1hel-sensor_116-116_EF1e-12-%j.err
#SBATCH --mem=2G
...
python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel 1hel_sensor/mesh/1hel_d16_split 116 116 1 2 1hel-sensor_116-116-2_EF1e-12
