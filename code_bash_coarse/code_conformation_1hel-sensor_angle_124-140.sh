...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_124-140_EF1e-12
#SBATCH -o 1hel-sensor_124-140_EF1e-12-%j.out
#SBATCH -e 1hel-sensor_124-140_EF1e-12-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_sensor 1hel mesh/1hel_d16_split 124 140 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel 1hel_sensor/mesh/1hel_d16_split 124 140 5 2 1hel-sensor_124-140-2_EF1e-12
